function [gamma1, gamma2] = vanLaar(A12,A21, x1, x2)
% calculates gammas for binary using 2 Parameter van Laar
...
% x1(i) and x2(i).
if(x1 == 0)
  x1 = 1e-50; % avoid blowup with zero
end
if(x2 == 0)
  x2 = 1e-50; % avoid blowup with zero
end  
gamma1 = exp(A12./(1+A12*x1./A21./x2).^2);
gamma2 = exp(A21./(1+A21*x2./A12./x1).^2);
return
